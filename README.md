Quick Search: First capstone for Thinkful utilizing API's from Google Books, Wikipedia, and Youtube. Enter a search term and receive data from all three API's simultaneously. 
